        ...
        <div className="container p-0 m-0 list-none flex bg-gray-700 justify-around flex-row flex-wrap">
          <div className="left item p-5 h-full mt-5 font-bold text-center">
            ...
            <form className="mx-auto md:w-1/2">
              <label className="block mb-2 text-xs font-bold uppercase" htmlFor="invoice-num">
                Invoice Number
              </label>

              <input className="w-full mb-6 form-input" id="invoice-num" placeholder="100" type="text" />

              <label className="block mb-2 text-xs font-bold uppercase" htmlFor="invoice-date">
                Invoice Date
              </label>

              <input className="w-full mb-6 form-input" id="invoice-date" placeholder="Murray" type="text" />

              <label className="block mb-2 text-xs font-bold uppercase" htmlFor="billTo">
                Bill To
              </label>

              <textarea className="w-full mb-6 form-textarea" id="billTo" placeholder="Say something..." rows="8" />
